...
//
//   void set_x(double initial_x = 0.0)
//     Postcondition: The x coordinate of the point has been set to (initial_x).
//
//   void set_y(double initial_y = 0.0)
//     Postcondition: The y coordinate of the point has been set to (initial_y).
//
...
public:
    ...
    void shift(double x_amount, double y_amount);
    void rotate90( );
    void set_x(double initial_x = 0.0) { x = initial_x; };
    void set_y(double initial_y = 0.0) { y = initial_y; };
